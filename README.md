...
Inserindo as regras de acesso.
    
    INSERT INTO public.authorities (name, description) VALUES ('admin', 'Administrador');
    INSERT INTO public.authorities (name, description) VALUES ('user', 'Usuario');
